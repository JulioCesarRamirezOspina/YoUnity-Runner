...
{
    [CreateAssetMenu(fileName = "runnerr_", menuName = "Antojate/Nivel Runner", order = 0)]
    public class NivelRunner : ScriptableObject
    {
        /// <summary>
        ...
        /// </param>
        public void SaveValues(NivelRunner updatedLevel)
        {
